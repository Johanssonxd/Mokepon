...
function unirseAlJuego() {
    fetch('http://192.168.100.21:8080/unirse')//Petición asincrona, ya que no se sabe cuanto tiempo tardará el server en responder
        .then(function (res){
            if(res.ok){
                res.text()
...
function seleccionarMokepon(mokeponJugador) {
    fetch(`http://192.168.100.21:8080/mokepon/${jugadorId}`, {
        method: 'post',
        headers: {
...
function enviarAtaque() {
    fetch(`http://192.168.100.21:8080/mokepon/${jugadorId}/ataque`, {
        method: 'post',
        headers: {
            "Content-Type": "application/json"
        },
...
function obtenerAtaque() {
    fetch(`http://192.168.100.21:8080/mokepon/${enemigoId}/ataque`)
        .then(function (res) {
            if (res.ok) {
                res.json()
...
function enviarPosicion(x, y) {
    fetch(`http://192.168.100.21:8080/mokepon/${jugadorId}/posicion`, {
        method: 'post',
        headers: {
            'Content-Type': 'application/json'
        },
